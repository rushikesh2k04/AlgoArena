...
import { Wallet, LogOut, Gamepad2, Users, User } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 animate-float">
              <Gamepad2 className="w-8 h-8 text-primary drop-shadow-glow" />
               <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 bg-clip-text text-transparent mt-2 drop-shadow-lg">
                AlgoArena
              </Link>
            ...
            {isConnected ? (
              <div className="flex items-center gap-4">
                ...
                <Button variant="outline" onClick={handleDisconnect} className="gap-2 hover:scale-105 transition-transform">
